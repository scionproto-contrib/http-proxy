...
func TestNetwork_Listen(t *testing.T) {
	tests := []struct {
		...
		{"Invalid network", "not-SCION", "[1-ff00:0:110,127.0.0.1]:12345", true},
		{"Valid SCION IPv4 network and address", SCION, "[1-ff00:0:110,127.0.0.1]:12345", false},
		{"Valid SCION any IPv4 network and port", SCION, "[1-ff00:0:110,0.0.0.0]:12345", false},
		{"Valid SCION any IPv6 network and port", SCION, "[1-ff00:0:110,::]:12345", false},
		{"Valid SCION+dummy IPv4 network and address", SCIONDummy, "[1-ff00:0:110,127.0.0.1]:12345", false},
		{"Invalid SCION+UDP address", SCION, "invalid-address", true},
	}
